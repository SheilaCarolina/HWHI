...
<html>
	...
	<body align = "center">
		...
		<?php
				$sql = "SELECT * FROM `tema1_o_que_e_a_vida`";
		...
		<div class="fixed-action-btn">
		  <a href = "cadTrabalho1.php" class="btn-floating btn-large blue btn tooltipped" data-position="left" data-tooltip="Cadastrar trabalho">
