		...
		?>
					<br>
						<div class="row container">
							<form action="../Control/ControlCadTrabalho2.php" method="post" enctype = "multipart/form-data" class="col s12">
								<fieldset class = "formulario black">
									<h5 class="light" style="color: white" align="center">Saiba como um terremoto pode afetar a sua vida!</h5>
